...
for it in combinations:
    ...
    six.print_(str(it) + ' idzie, zostaje available - krok 1')
    for it2 in itertools.combinations(meta, 1):
        six.print_(str(it2) + ' wraca - krok 2')
        ...
        for it3 in itertools.combinations(available2, 2):
            six.print_(str(it3) + ' idzie, zostaje available - krok 3')
...
six.print_(famous_validation)
six.print_(famous_result)
